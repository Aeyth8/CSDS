...
static_assert(offsetof(ItemTransformItemPicker_C_ExecuteUbergraph_ItemTransformItemPicker, CallFunc_GetContext_ReturnValue) == 0x000008, "Member 'ItemTransformItemPicker_C_ExecuteUbergraph_ItemTransformItemPicker::CallFunc_GetContext_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemTransformItemPicker_C_ExecuteUbergraph_ItemTransformItemPicker, CallFunc_IsMobileApp_ReturnValue) == 0x000010, "Member 'ItemTransformItemPicker_C_ExecuteUbergraph_ItemTransformItemPicker::CallFunc_IsMobileApp_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemTransformItemPicker_C_ExecuteUbergraph_ItemTransformItemPicker, K2Node_Event_IsDesignTime) == 0x000011, "Member 'ItemTransformItemPicker_C_ExecuteUbergraph_ItemTransformItemPicker::K2Node_Event_IsDesignTime' has a wrong offset!");
static_assert(offsetof(ItemTransformItemPicker_C_ExecuteUbergraph_ItemTransformItemPicker, K2Node_ComponentBoundEvent_TabId) == 0x000018, "Member 'ItemTransformItemPicker_C_ExecuteUbergraph_ItemTransformItemPicker::K2Node_ComponentBoundEvent_TabId' has a wrong offset!");
