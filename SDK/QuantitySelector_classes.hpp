...
static_assert(sizeof(UQuantitySelector_C) == 0x000B90, "Wrong size on UQuantitySelector_C");
...
static_assert(offsetof(UQuantitySelector_C, bShowConfirmButton) == 0x000B88, "Member 'UQuantitySelector_C::bShowConfirmButton' has a wrong offset!");
static_assert(offsetof(UQuantitySelector_C, bShowCancelButton) == 0x000B89, "Member 'UQuantitySelector_C::bShowCancelButton' has a wrong offset!");
static_assert(offsetof(UQuantitySelector_C, bAllowZeroQuantity) == 0x000B8A, "Member 'UQuantitySelector_C::bAllowZeroQuantity' has a wrong offset!");
