...
static_assert(sizeof(MainTabsScreen_C_HandleTabSelected) == 0x000030, "Wrong size on MainTabsScreen_C_HandleTabSelected");
...
static_assert(offsetof(MainTabsScreen_C_HandleTabSelected, CallFunc_GetActiveWidgetIndex_ReturnValue) == 0x000008, "Member 'MainTabsScreen_C_HandleTabSelected::CallFunc_GetActiveWidgetIndex_ReturnValue' has a wrong offset!");
static_assert(offsetof(MainTabsScreen_C_HandleTabSelected, CallFunc_GetChildAt_ReturnValue) == 0x000010, "Member 'MainTabsScreen_C_HandleTabSelected::CallFunc_GetChildAt_ReturnValue' has a wrong offset!");
static_assert(offsetof(MainTabsScreen_C_HandleTabSelected, K2Node_DynamicCast_AsHome_Screen_Next_Quest) == 0x000018, "Member 'MainTabsScreen_C_HandleTabSelected::K2Node_DynamicCast_AsHome_Screen_Next_Quest' has a wrong offset!");
static_assert(offsetof(MainTabsScreen_C_HandleTabSelected, K2Node_DynamicCast_bSuccess) == 0x000020, "Member 'MainTabsScreen_C_HandleTabSelected::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(MainTabsScreen_C_HandleTabSelected, CallFunc_GetActiveTab_ReturnValue) == 0x000028, "Member 'MainTabsScreen_C_HandleTabSelected::CallFunc_GetActiveTab_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(MainTabsScreen_C_CheckDisplayCriteria) == 0x0000F0, "Wrong size on MainTabsScreen_C_CheckDisplayCriteria");
...
static_assert(offsetof(MainTabsScreen_C_CheckDisplayCriteria, CallFunc_GetAccountItemWithDefinition_ReturnValue) == 0x0000E0, "Member 'MainTabsScreen_C_CheckDisplayCriteria::CallFunc_GetAccountItemWithDefinition_ReturnValue' has a wrong offset!");
static_assert(offsetof(MainTabsScreen_C_CheckDisplayCriteria, CallFunc_IsValid_ReturnValue) == 0x0000E8, "Member 'MainTabsScreen_C_CheckDisplayCriteria::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(MainTabsScreen_C_CheckDisplayCriteria, CallFunc_GetNumInStack_ReturnValue) == 0x0000EC, "Member 'MainTabsScreen_C_CheckDisplayCriteria::CallFunc_GetNumInStack_ReturnValue' has a wrong offset!");
