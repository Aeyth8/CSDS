...
// Parameters:
// EAthenaCustomizationCategory            CustomizationType_0                                    (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
// class UCommonButton*                    Button                                                 (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class FText                             BannerLabel_0                                          (Parm)

void UAthenaCustomizationSlotButtonWrapper_C::OnSlotClicked__DelegateSignature(EAthenaCustomizationCategory CustomizationType_0, class UCommonButton* Button, const class FText& BannerLabel_0)
{
	...
	Parms.Button = Button;
	Parms.BannerLabel_0 = std::move(BannerLabel_0);
