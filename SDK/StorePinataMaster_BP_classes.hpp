...
public:
	...
	class UMaterialInstanceDynamic*               MIDMinusLlamaLeather;                              // 0x0BD0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(AStorePinataMaster_BP_C) == 0x000BE0, "Wrong size on AStorePinataMaster_BP_C");
...
static_assert(offsetof(AStorePinataMaster_BP_C, MIDMinusLlamaLeather) == 0x000BD0, "Member 'AStorePinataMaster_BP_C::MIDMinusLlamaLeather' has a wrong offset!");
