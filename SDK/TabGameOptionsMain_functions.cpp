...
void UTabGameOptionsMain_C::BndEvt__ConsoleUnlockedFPS_K2Node_ComponentBoundEvent_300_Selection_Changed__DelegateSignature(int32 Selected_Index)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("TabGameOptionsMain_C", "BndEvt__ConsoleUnlockedFPS_K2Node_ComponentBoundEvent_300_Selection Changed__DelegateSignature");

	Params::TabGameOptionsMain_C_BndEvt__ConsoleUnlockedFPS_K2Node_ComponentBoundEvent_300_Selection_Changed__DelegateSignature Parms{};
...
void UTabGameOptionsMain_C::IntializeGamepadSensitivitySliders()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("TabGameOptionsMain_C", "IntializeGamepadSensitivitySliders");
