...
public:
	...
	bool                                          bShowForXBox;                                      // 0x02B6(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bShowForIOS;                                       // 0x02B7(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bShowForAndroid;                                   // 0x02B8(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ESlateVisibility                              VisibleType;                                       // 0x02B9(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ESlateVisibility                              HiddenType;                                        // 0x02BA(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UCommonVisibilityWidget, bShowForTouch) == 0x0002B2, "Member 'UCommonVisibilityWidget::bShowForTouch' has a wrong offset!");
static_assert(offsetof(UCommonVisibilityWidget, bShowForPC) == 0x0002B3, "Member 'UCommonVisibilityWidget::bShowForPC' has a wrong offset!");
static_assert(offsetof(UCommonVisibilityWidget, bShowForMac) == 0x0002B4, "Member 'UCommonVisibilityWidget::bShowForMac' has a wrong offset!");
static_assert(offsetof(UCommonVisibilityWidget, bShowForPS4) == 0x0002B5, "Member 'UCommonVisibilityWidget::bShowForPS4' has a wrong offset!");
static_assert(offsetof(UCommonVisibilityWidget, bShowForXBox) == 0x0002B6, "Member 'UCommonVisibilityWidget::bShowForXBox' has a wrong offset!");
static_assert(offsetof(UCommonVisibilityWidget, bShowForIOS) == 0x0002B7, "Member 'UCommonVisibilityWidget::bShowForIOS' has a wrong offset!");
static_assert(offsetof(UCommonVisibilityWidget, bShowForAndroid) == 0x0002B8, "Member 'UCommonVisibilityWidget::bShowForAndroid' has a wrong offset!");
static_assert(offsetof(UCommonVisibilityWidget, VisibleType) == 0x0002B9, "Member 'UCommonVisibilityWidget::VisibleType' has a wrong offset!");
static_assert(offsetof(UCommonVisibilityWidget, HiddenType) == 0x0002BA, "Member 'UCommonVisibilityWidget::HiddenType' has a wrong offset!");
...
static_assert(sizeof(UCommonDateTimeTextBlock) == 0x0002B8, "Wrong size on UCommonDateTimeTextBlock");
