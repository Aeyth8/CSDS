...
public:
	...
	bool                                          K2Node_Event_bUsingGamepad;                        // 0x0108(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
static_assert(sizeof(ItemInspectScreen_C_ExecuteUbergraph_ItemInspectScreen) == 0x000110, "Wrong size on ItemInspectScreen_C_ExecuteUbergraph_ItemInspectScreen");
...
static_assert(offsetof(ItemInspectScreen_C_ExecuteUbergraph_ItemInspectScreen, K2Node_Event_bUsingGamepad) == 0x000108, "Member 'ItemInspectScreen_C_ExecuteUbergraph_ItemInspectScreen::K2Node_Event_bUsingGamepad' has a wrong offset!");
...
public:
	...
	struct FDataTableRowHandle                    K2Node_MakeStruct_DataTableRowHandle7;             // 0x00C0(0x0010)(NoDestructor)
	TDelegate<void(bool* bPassThrough)>           K2Node_CreateDelegate_OutputDelegate7;             // 0x00D0(0x0010)(ZeroConstructor, NoDestructor)
...
static_assert(sizeof(ItemInspectScreen_C_SetupActionHandlers) == 0x000100, "Wrong size on ItemInspectScreen_C_SetupActionHandlers");
...
static_assert(offsetof(ItemInspectScreen_C_SetupActionHandlers, K2Node_MakeStruct_DataTableRowHandle7) == 0x0000C0, "Member 'ItemInspectScreen_C_SetupActionHandlers::K2Node_MakeStruct_DataTableRowHandle7' has a wrong offset!");
static_assert(offsetof(ItemInspectScreen_C_SetupActionHandlers, K2Node_CreateDelegate_OutputDelegate7) == 0x0000D0, "Member 'ItemInspectScreen_C_SetupActionHandlers::K2Node_CreateDelegate_OutputDelegate7' has a wrong offset!");
