...
public:
	...
	class UImage*                                 Image_0;                                           // 0x08D8(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	class UMaterialInstanceDynamic*               ColorMID;                                          // 0x08E8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	UMulticastDelegateProperty_                   BannerTileBangUpdated;                             // 0x08F0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
...
static_assert(sizeof(UBP_BannerEditorTile_C) == 0x000900, "Wrong size on UBP_BannerEditorTile_C");
...
static_assert(offsetof(UBP_BannerEditorTile_C, Image_0) == 0x0008D8, "Member 'UBP_BannerEditorTile_C::Image_0' has a wrong offset!");
static_assert(offsetof(UBP_BannerEditorTile_C, NormalBangWrapper) == 0x0008E0, "Member 'UBP_BannerEditorTile_C::NormalBangWrapper' has a wrong offset!");
static_assert(offsetof(UBP_BannerEditorTile_C, ColorMID) == 0x0008E8, "Member 'UBP_BannerEditorTile_C::ColorMID' has a wrong offset!");
static_assert(offsetof(UBP_BannerEditorTile_C, BannerTileBangUpdated) == 0x0008F0, "Member 'UBP_BannerEditorTile_C::BannerTileBangUpdated' has a wrong offset!");
