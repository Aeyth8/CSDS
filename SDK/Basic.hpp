...
namespace Offsets
{
	constexpr int32 GObjects          = 0x067E5D60;
	constexpr int32 AppendString      = 0x013631B0;
	constexpr int32 GNames            = 0x067DCFF8;
	constexpr int32 GWorld            = 0x068D1910;
	constexpr int32 ProcessEvent      = 0x01452A60;
