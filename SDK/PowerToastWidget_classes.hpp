...
static_assert(sizeof(UPowerToastWidget_C) == 0x000308, "Wrong size on UPowerToastWidget_C");
...
static_assert(offsetof(UPowerToastWidget_C, SynchronizeTimeoutTimer) == 0x0002F8, "Member 'UPowerToastWidget_C::SynchronizeTimeoutTimer' has a wrong offset!");
static_assert(offsetof(UPowerToastWidget_C, SynchronizeTimeoutDuration) == 0x000300, "Member 'UPowerToastWidget_C::SynchronizeTimeoutDuration' has a wrong offset!");
