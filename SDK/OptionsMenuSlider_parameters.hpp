...
public:
	...
	struct FPointerEvent                          K2Node_Event_MouseEvent2;                          // 0x0010(0x0078)(ConstParm)
	...
	struct FLinearColor                           K2Node_MakeStruct_LinearColor;                     // 0x0148(0x0010)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FLinearColor                           K2Node_MakeStruct_LinearColor2;                    // 0x0158(0x0010)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_GetValue_ReturnValue;                     // 0x0168(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_GetValue_ReturnValue2;                    // 0x016C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_GetValue_ReturnValue3;                    // 0x0170(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(OptionsMenuSlider_C_ExecuteUbergraph_OptionsMenuSlider) == 0x000198, "Wrong size on OptionsMenuSlider_C_ExecuteUbergraph_OptionsMenuSlider");
...
static_assert(offsetof(OptionsMenuSlider_C_ExecuteUbergraph_OptionsMenuSlider, K2Node_MakeStruct_LinearColor) == 0x000148, "Member 'OptionsMenuSlider_C_ExecuteUbergraph_OptionsMenuSlider::K2Node_MakeStruct_LinearColor' has a wrong offset!");
static_assert(offsetof(OptionsMenuSlider_C_ExecuteUbergraph_OptionsMenuSlider, K2Node_MakeStruct_LinearColor2) == 0x000158, "Member 'OptionsMenuSlider_C_ExecuteUbergraph_OptionsMenuSlider::K2Node_MakeStruct_LinearColor2' has a wrong offset!");
static_assert(offsetof(OptionsMenuSlider_C_ExecuteUbergraph_OptionsMenuSlider, CallFunc_GetValue_ReturnValue) == 0x000168, "Member 'OptionsMenuSlider_C_ExecuteUbergraph_OptionsMenuSlider::CallFunc_GetValue_ReturnValue' has a wrong offset!");
static_assert(offsetof(OptionsMenuSlider_C_ExecuteUbergraph_OptionsMenuSlider, CallFunc_GetValue_ReturnValue2) == 0x00016C, "Member 'OptionsMenuSlider_C_ExecuteUbergraph_OptionsMenuSlider::CallFunc_GetValue_ReturnValue2' has a wrong offset!");
static_assert(offsetof(OptionsMenuSlider_C_ExecuteUbergraph_OptionsMenuSlider, CallFunc_GetValue_ReturnValue3) == 0x000170, "Member 'OptionsMenuSlider_C_ExecuteUbergraph_OptionsMenuSlider::CallFunc_GetValue_ReturnValue3' has a wrong offset!");
static_assert(offsetof(OptionsMenuSlider_C_ExecuteUbergraph_OptionsMenuSlider, CallFunc_Less_FloatFloat_ReturnValue) == 0x000174, "Member 'OptionsMenuSlider_C_ExecuteUbergraph_OptionsMenuSlider::CallFunc_Less_FloatFloat_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(OptionsMenuSlider_C_ExecuteUbergraph_OptionsMenuSlider, CallFunc_Conv_FloatToText_ReturnValue) == 0x000180, "Member 'OptionsMenuSlider_C_ExecuteUbergraph_OptionsMenuSlider::CallFunc_Conv_FloatToText_ReturnValue' has a wrong offset!");
