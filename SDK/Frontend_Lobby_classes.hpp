...
static_assert(sizeof(AFrontend_Lobby_C) == 0x0003B0, "Wrong size on AFrontend_Lobby_C");
...
static_assert(offsetof(AFrontend_Lobby_C, LobbySelect) == 0x0003A8, "Member 'AFrontend_Lobby_C::LobbySelect' has a wrong offset!");
