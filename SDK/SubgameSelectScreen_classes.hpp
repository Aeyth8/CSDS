...
public:
	...
	class UMaterialInstanceDynamic*               MIDMinusKeyart;                                    // 0x04C8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(USubgameSelectScreen_C) == 0x0004F0, "Wrong size on USubgameSelectScreen_C");
...
static_assert(offsetof(USubgameSelectScreen_C, ButtonExit) == 0x000448, "Member 'USubgameSelectScreen_C::ButtonExit' has a wrong offset!");
static_assert(offsetof(USubgameSelectScreen_C, ButtonPurchase) == 0x000450, "Member 'USubgameSelectScreen_C::ButtonPurchase' has a wrong offset!");
static_assert(offsetof(USubgameSelectScreen_C, ButtonRedeem) == 0x000458, "Member 'USubgameSelectScreen_C::ButtonRedeem' has a wrong offset!");
static_assert(offsetof(USubgameSelectScreen_C, CampaignBtn) == 0x000460, "Member 'USubgameSelectScreen_C::CampaignBtn' has a wrong offset!");
static_assert(offsetof(USubgameSelectScreen_C, ConsoleProfileWidget) == 0x000468, "Member 'USubgameSelectScreen_C::ConsoleProfileWidget' has a wrong offset!");
static_assert(offsetof(USubgameSelectScreen_C, FullDescription) == 0x000470, "Member 'USubgameSelectScreen_C::FullDescription' has a wrong offset!");
static_assert(offsetof(USubgameSelectScreen_C, Image_0) == 0x000478, "Member 'USubgameSelectScreen_C::Image_0' has a wrong offset!");
static_assert(offsetof(USubgameSelectScreen_C, Image_1) == 0x000480, "Member 'USubgameSelectScreen_C::Image_1' has a wrong offset!");
static_assert(offsetof(USubgameSelectScreen_C, PVEDescriptionBorder) == 0x000488, "Member 'USubgameSelectScreen_C::PVEDescriptionBorder' has a wrong offset!");
static_assert(offsetof(USubgameSelectScreen_C, PVEDescriptionText) == 0x000490, "Member 'USubgameSelectScreen_C::PVEDescriptionText' has a wrong offset!");
static_assert(offsetof(USubgameSelectScreen_C, PVPDescriptionBorder) == 0x000498, "Member 'USubgameSelectScreen_C::PVPDescriptionBorder' has a wrong offset!");
static_assert(offsetof(USubgameSelectScreen_C, PVPDescriptionText) == 0x0004A0, "Member 'USubgameSelectScreen_C::PVPDescriptionText' has a wrong offset!");
static_assert(offsetof(USubgameSelectScreen_C, SwitcherMenu) == 0x0004A8, "Member 'USubgameSelectScreen_C::SwitcherMenu' has a wrong offset!");
static_assert(offsetof(USubgameSelectScreen_C, TitleImage) == 0x0004B0, "Member 'USubgameSelectScreen_C::TitleImage' has a wrong offset!");
static_assert(offsetof(USubgameSelectScreen_C, WasLastPlayForward) == 0x0004B8, "Member 'USubgameSelectScreen_C::WasLastPlayForward' has a wrong offset!");
static_assert(offsetof(USubgameSelectScreen_C, LeavingMatchmakingDialog) == 0x0004C0, "Member 'USubgameSelectScreen_C::LeavingMatchmakingDialog' has a wrong offset!");
static_assert(offsetof(USubgameSelectScreen_C, MIDMinusKeyart) == 0x0004C8, "Member 'USubgameSelectScreen_C::MIDMinusKeyart' has a wrong offset!");
static_assert(offsetof(USubgameSelectScreen_C, CycleTimer) == 0x0004D0, "Member 'USubgameSelectScreen_C::CycleTimer' has a wrong offset!");
static_assert(offsetof(USubgameSelectScreen_C, PveRotatorIndex) == 0x0004D8, "Member 'USubgameSelectScreen_C::PveRotatorIndex' has a wrong offset!");
static_assert(offsetof(USubgameSelectScreen_C, Items) == 0x0004E0, "Member 'USubgameSelectScreen_C::Items' has a wrong offset!");
