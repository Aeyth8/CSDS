...
static_assert(offsetof(FrontEndRewards_Widget_C_CreateCardsFromItemList, CallFunc_Array_Get_Item) == 0x00006C, "Member 'FrontEndRewards_Widget_C_CreateCardsFromItemList::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(FrontEndRewards_Widget_C_CreateCardsFromItemList, CallFunc_Array_IsValidIndex_ReturnValue) == 0x00006D, "Member 'FrontEndRewards_Widget_C_CreateCardsFromItemList::CallFunc_Array_IsValidIndex_ReturnValue' has a wrong offset!");
static_assert(offsetof(FrontEndRewards_Widget_C_CreateCardsFromItemList, CallFunc_EqualEqual_ByteByte_ReturnValue) == 0x00006E, "Member 'FrontEndRewards_Widget_C_CreateCardsFromItemList::CallFunc_EqualEqual_ByteByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(FrontEndRewards_Widget_C_CreateCardsFromItemList, CallFunc_Array_Get_Item2) == 0x000070, "Member 'FrontEndRewards_Widget_C_CreateCardsFromItemList::CallFunc_Array_Get_Item2' has a wrong offset!");
static_assert(offsetof(FrontEndRewards_Widget_C_CreateCardsFromItemList, CallFunc_Array_Add_ReturnValue) == 0x000078, "Member 'FrontEndRewards_Widget_C_CreateCardsFromItemList::CallFunc_Array_Add_ReturnValue' has a wrong offset!");
