...
static_assert(sizeof(AthenaInventoryEquipSlot_C_ExecuteUbergraph_AthenaInventoryEquipSlot) == 0x000080, "Wrong size on AthenaInventoryEquipSlot_C_ExecuteUbergraph_AthenaInventoryEquipSlot");
...
static_assert(offsetof(AthenaInventoryEquipSlot_C_ExecuteUbergraph_AthenaInventoryEquipSlot, Temp_byte_Variable2) == 0x000005, "Member 'AthenaInventoryEquipSlot_C_ExecuteUbergraph_AthenaInventoryEquipSlot::Temp_byte_Variable2' has a wrong offset!");
...
static_assert(offsetof(AthenaInventoryEquipSlot_C_ExecuteUbergraph_AthenaInventoryEquipSlot, CallFunc_GetContext_ReturnValue2) == 0x000010, "Member 'AthenaInventoryEquipSlot_C_ExecuteUbergraph_AthenaInventoryEquipSlot::CallFunc_GetContext_ReturnValue2' has a wrong offset!");
static_assert(offsetof(AthenaInventoryEquipSlot_C_ExecuteUbergraph_AthenaInventoryEquipSlot, CallFunc_IsUsingGamepad_ReturnValue) == 0x000018, "Member 'AthenaInventoryEquipSlot_C_ExecuteUbergraph_AthenaInventoryEquipSlot::CallFunc_IsUsingGamepad_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(AthenaInventoryEquipSlot_C_ExecuteUbergraph_AthenaInventoryEquipSlot, Temp_bool_Variable) == 0x00003B, "Member 'AthenaInventoryEquipSlot_C_ExecuteUbergraph_AthenaInventoryEquipSlot::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(AthenaInventoryEquipSlot_C_ExecuteUbergraph_AthenaInventoryEquipSlot, K2Node_Select_Default) == 0x00003C, "Member 'AthenaInventoryEquipSlot_C_ExecuteUbergraph_AthenaInventoryEquipSlot::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(AthenaInventoryEquipSlot_C_ExecuteUbergraph_AthenaInventoryEquipSlot, K2Node_Event_MyGeometry) == 0x000040, "Member 'AthenaInventoryEquipSlot_C_ExecuteUbergraph_AthenaInventoryEquipSlot::K2Node_Event_MyGeometry' has a wrong offset!");
static_assert(offsetof(AthenaInventoryEquipSlot_C_ExecuteUbergraph_AthenaInventoryEquipSlot, K2Node_Event_InDeltaTime) == 0x000074, "Member 'AthenaInventoryEquipSlot_C_ExecuteUbergraph_AthenaInventoryEquipSlot::K2Node_Event_InDeltaTime' has a wrong offset!");
static_assert(offsetof(AthenaInventoryEquipSlot_C_ExecuteUbergraph_AthenaInventoryEquipSlot, K2Node_CustomEvent_QuickbarIndex) == 0x000078, "Member 'AthenaInventoryEquipSlot_C_ExecuteUbergraph_AthenaInventoryEquipSlot::K2Node_CustomEvent_QuickbarIndex' has a wrong offset!");
...
static_assert(sizeof(AthenaInventoryEquipSlot_C_TryAndShowDropTarget) == 0x000028, "Wrong size on AthenaInventoryEquipSlot_C_TryAndShowDropTarget");
static_assert(offsetof(AthenaInventoryEquipSlot_C_TryAndShowDropTarget, CallFunc_GetDragDroppingContent_ReturnValue) == 0x000000, "Member 'AthenaInventoryEquipSlot_C_TryAndShowDropTarget::CallFunc_GetDragDroppingContent_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaInventoryEquipSlot_C_TryAndShowDropTarget, CallFunc_GetDragDroppingContent_ReturnValue2) == 0x000008, "Member 'AthenaInventoryEquipSlot_C_TryAndShowDropTarget::CallFunc_GetDragDroppingContent_ReturnValue2' has a wrong offset!");
static_assert(offsetof(AthenaInventoryEquipSlot_C_TryAndShowDropTarget, CallFunc_IsValid_ReturnValue) == 0x000010, "Member 'AthenaInventoryEquipSlot_C_TryAndShowDropTarget::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaInventoryEquipSlot_C_TryAndShowDropTarget, K2Node_DynamicCast_AsFort_Item) == 0x000018, "Member 'AthenaInventoryEquipSlot_C_TryAndShowDropTarget::K2Node_DynamicCast_AsFort_Item' has a wrong offset!");
static_assert(offsetof(AthenaInventoryEquipSlot_C_TryAndShowDropTarget, K2Node_DynamicCast_bSuccess) == 0x000020, "Member 'AthenaInventoryEquipSlot_C_TryAndShowDropTarget::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(AthenaInventoryEquipSlot_C_TryAndShowDropTarget, CallFunc_GetType_ReturnValue) == 0x000021, "Member 'AthenaInventoryEquipSlot_C_TryAndShowDropTarget::CallFunc_GetType_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaInventoryEquipSlot_C_TryAndShowDropTarget, CallFunc_EqualEqual_ByteByte_ReturnValue) == 0x000022, "Member 'AthenaInventoryEquipSlot_C_TryAndShowDropTarget::CallFunc_EqualEqual_ByteByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaInventoryEquipSlot_C_TryAndShowDropTarget, CallFunc_EqualEqual_ByteByte_ReturnValue2) == 0x000023, "Member 'AthenaInventoryEquipSlot_C_TryAndShowDropTarget::CallFunc_EqualEqual_ByteByte_ReturnValue2' has a wrong offset!");
static_assert(offsetof(AthenaInventoryEquipSlot_C_TryAndShowDropTarget, CallFunc_BooleanOR_ReturnValue) == 0x000024, "Member 'AthenaInventoryEquipSlot_C_TryAndShowDropTarget::CallFunc_BooleanOR_ReturnValue' has a wrong offset!");
